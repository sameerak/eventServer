 ...
 */
public class EventProcessor7617 {
...
//                count++;
        ...
        EventServer eventServer = new EventServer(new EventServerConfig(7617), streamDefinition, new org.wso2.event.server.StreamCallback() {
            @Override
